...
- `NEXT_PUBLIC_SUPABASE_PUBLISHABLE_DEFAULT_KEY` (recommended)
- `SUPABASE_SECRET_KEY` (recommended, server/admin)
- Legacy fallbacks: `NEXT_PUBLIC_SUPABASE_ANON_KEY`, `SUPABASE_SERVICE_ROLE_KEY`
